...
if __name__ == '__main__':
    ...
    char.PrepareSpell(0, spell.LoadSpellByName('Light'), 0)
    ...
    char.PrepareSpell(0, spell.LoadSpellByName('Murderous Command'), 0)
    ...
    char.PrepareSpell(0, spell.LoadSpellByName('Instant Armor'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Shield Other'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Life Pact'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Grace'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Sound Burst'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Summon Monster II'), 0)
    ...
    char.PrepareSpell(0, spell.LoadSpellByName('Prayer'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Magic Vestment'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Align Weapon, Communal'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Stone Shape'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Wind Wall'), 0)
    char.PrepareSpell(0, spell.LoadSpellByName('Cure Serious Wounds'), 0, True)
